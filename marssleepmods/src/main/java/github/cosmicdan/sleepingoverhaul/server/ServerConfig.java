...
public class ServerConfig {
    ...
    public final ModConfigSpec.EnumValue<SleepAction> sleepAction;
    private static final String sleepActionTxt = " The action to perform when all players are sleeping";
    public final ModConfigSpec.BooleanValue resetWeatherOnWake;
    ...
    public final ModConfigSpec.BooleanValue logTimelapsePerformanceStats;
    ...
    public final ModConfigSpec.BooleanValue noDamageToNonSleepers;
    public final ModConfigSpec.EnumValue<AttackedWhileSleepingAction> timelapseSleepersDirectDamageAction;
    ...
    public final ModConfigSpec.BooleanValue noMovementDuringTimelapse;
    ...
    public final ModConfigSpec.BooleanValue disableNaturalSpawning;
    ...
    public final ModConfigSpec.BooleanValue disableLivingEntityTravel;
    ...
    public final ModConfigSpec.BooleanValue featureAllowAnyDimension;
    ...
    public final ModConfigSpec.BooleanValue featureSetSpawnAnyDimension;
